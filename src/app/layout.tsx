...
export const metadata: Metadata = {
  title: "Grand Azure Resort - Luxury Ocean Front Hotel",
  description: "Experience unparalleled luxury at Grand Azure Resort. Five-star accommodations, world-class amenities, oceanfront location, award-winning spa and dining.",
  keywords: ["luxury hotel", "ocean resort", "five star hotel", "spa resort", "fine dining", "luxury accommodation"],
  metadataBase: new URL("https://grandazureresort.com"),
  alternates: {
    canonical: "https://grandazureresort.com"
  },
  openGraph: {
    title: "Grand Azure Resort - Luxury Ocean Front Hotel",
    description: "Experience unparalleled luxury at Grand Azure Resort with oceanfront views, world-class amenities, and exceptional service.",
    url: "https://grandazureresort.com",
    siteName: "Grand Azure Resort",
    images: [
      {
        url: "https://images.pexels.com/photos/2149421/pexels-photo-2149421.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Grand Azure Resort luxury exterior"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Grand Azure Resort - Luxury Ocean Front Hotel",
    description: "Experience unparalleled luxury at Grand Azure Resort with oceanfront views and exceptional service.",
    images: ["https://images.pexels.com/photos/2149421/pexels-photo-2149421.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
